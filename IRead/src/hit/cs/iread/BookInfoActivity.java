...
public class BookInfoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//this.desk = new Desk();
		//this.desk.init(this.helper);
		Intent it = super.getIntent();
		this.book = DeskView.desk.searchBook(it.getStringExtra("iSBN"));
		if(DeskView.desk.isInDesk(it.getStringExtra("iSBN")))
		...
		this.button.setOnClickListener(new OnClickListener() {
			public void onClick(View view) {
				DeskView.desk.addBook(BookInfoActivity.this.book);
				Notebook notebook = new Notebook();
				notebook.setBook(BookInfoActivity.this.book);
				DeskView.desk.addNotebook(notebook);
